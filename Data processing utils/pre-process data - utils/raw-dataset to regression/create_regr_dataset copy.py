...
#GLOBAL MACROS
INPUT_DIRECTORY="C:\\Users\\22218521\\Desktop\\Katlego Mbatha\\Collected data (2022)\\1-290"

OUTPUT_DIRECTORY_NAME="dataset_2"
...
for cat in CONFIG:
    ...
    for identity in cat['data']:
        ...
        identity_data=list(filter(lambda x:'jpg' in x,identity_data))

        #APPLY PRE-PROCESING ON IDENTITY IMAGES
        images=find_crop_face([f"{DIR}\\{x}" for x in identity_data],pad = -100,dimension = 200)
